...
> Operational response guide for **Runbooks / Fraud Alert Spike**.

## Purpose

Use this runbook when runbooks / fraud alert spike is suspected or confirmed. The goal is to protect transaction integrity, maintain tenant isolation, communicate clearly, and restore normal processing with evidence.
