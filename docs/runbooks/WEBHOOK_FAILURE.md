...
> Operational response guide for **Runbooks / Webhook Failure**.

## Purpose

Use this runbook when runbooks / webhook failure is suspected or confirmed. The goal is to protect transaction integrity, maintain tenant isolation, communicate clearly, and restore normal processing with evidence.
