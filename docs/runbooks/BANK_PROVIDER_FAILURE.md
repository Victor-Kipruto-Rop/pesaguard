# Bank Provider Failure

> Operational response guide for **Runbooks / Bank Provider Failure**.

## Purpose

Use this runbook when runbooks / bank provider failure is suspected or confirmed. The goal is to protect transaction integrity, maintain tenant isolation, communicate clearly, and restore normal processing with evidence.
