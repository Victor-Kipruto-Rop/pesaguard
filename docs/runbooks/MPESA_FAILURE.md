...
> Operational response guide for **Runbooks / Mpesa Failure**.

## Purpose

Use this runbook when runbooks / mpesa failure is suspected or confirmed. The goal is to protect transaction integrity, maintain tenant isolation, communicate clearly, and restore normal processing with evidence.
