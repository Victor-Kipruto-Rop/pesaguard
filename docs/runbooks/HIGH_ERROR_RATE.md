...
> Operational response guide for **Runbooks / High Error Rate**.

## Purpose

Use this runbook when runbooks / high error rate is suspected or confirmed. The goal is to protect transaction integrity, maintain tenant isolation, communicate clearly, and restore normal processing with evidence.
