...
> Design and operating reference for **Testing / E2E Testing**.

## Purpose

This document defines the role of **E2E Testing** within PesaGuard. It provides a durable reference for confidence-building checks across unit, integration, contract, security, performance, and end-to-end layers, with enough detail for implementation, review, operations, and future change.
