...
> Design and operating reference for **Testing / Security Testing**.

## Purpose

This document defines the role of **Security Testing** within PesaGuard. It provides a durable reference for confidence-building checks across unit, integration, contract, security, performance, and end-to-end layers, with enough detail for implementation, review, operations, and future change.
