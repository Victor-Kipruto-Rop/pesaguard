...
> Design and operating reference for **Database / Restore Procedures**.

## Purpose

This document defines the role of **Restore Procedures** within PesaGuard. It provides a durable reference for durable storage, schema evolution, retention, archival, backup, and restoration, with enough detail for implementation, review, operations, and future change.
