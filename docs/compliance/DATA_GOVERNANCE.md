...
> Design and operating reference for **Compliance / Data Governance**.

## Purpose

This document defines the role of **Data Governance** within PesaGuard. It provides a durable reference for governance, privacy, residency, access evidence, retention, and accountable controls, with enough detail for implementation, review, operations, and future change.
