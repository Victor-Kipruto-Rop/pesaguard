...
> Design and operating reference for **Compliance / Auditability**.

## Purpose

This document defines the role of **Auditability** within PesaGuard. It provides a durable reference for governance, privacy, residency, access evidence, retention, and accountable controls, with enough detail for implementation, review, operations, and future change.
