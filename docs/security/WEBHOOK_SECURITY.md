...
> Design and operating reference for **Security / Webhook Security**.

## Purpose

This document defines the role of **Webhook Security** within PesaGuard. It provides a durable reference for identity, authorization, confidentiality, integrity, threat reduction, and evidence, with enough detail for implementation, review, operations, and future change.
