...
> Design and operating reference for **Security / Audit Logging**.

## Purpose

This document defines the role of **Audit Logging** within PesaGuard. It provides a durable reference for identity, authorization, confidentiality, integrity, threat reduction, and evidence, with enough detail for implementation, review, operations, and future change.
