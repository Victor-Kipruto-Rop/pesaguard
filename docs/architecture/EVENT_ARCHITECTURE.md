...
> Design and operating reference for **Architecture / Event Architecture**.

## Purpose

This document defines the role of **Event Architecture** within PesaGuard. It provides a durable reference for system boundaries, ownership, dependencies, and evolution of the PesaGuard platform, with enough detail for implementation, review, operations, and future change.
