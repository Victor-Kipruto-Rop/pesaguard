...
> Design and operating reference for **Architecture / Target Architecture**.

## Purpose

This document defines the role of **Target Architecture** within PesaGuard. It provides a durable reference for system boundaries, ownership, dependencies, and evolution of the PesaGuard platform, with enough detail for implementation, review, operations, and future change.
