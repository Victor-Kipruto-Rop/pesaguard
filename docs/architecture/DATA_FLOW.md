...
> Design and operating reference for **Architecture / Data Flow**.

## Purpose

This document defines the role of **Data Flow** within PesaGuard. It provides a durable reference for system boundaries, ownership, dependencies, and evolution of the PesaGuard platform, with enough detail for implementation, review, operations, and future change.
