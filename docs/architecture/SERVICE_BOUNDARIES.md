...
> Design and operating reference for **Architecture / Service Boundaries**.

## Purpose

This document defines the role of **Service Boundaries** within PesaGuard. It provides a durable reference for system boundaries, ownership, dependencies, and evolution of the PesaGuard platform, with enough detail for implementation, review, operations, and future change.
