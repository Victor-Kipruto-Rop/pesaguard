...
> Design and operating reference for **Infrastructure / Redis**.

## Purpose

This document defines the role of **Redis** within PesaGuard. It provides a durable reference for runtime environments, platform dependencies, networking, deployment, and capacity, with enough detail for implementation, review, operations, and future change.
