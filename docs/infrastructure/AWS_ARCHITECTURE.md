...
> Design and operating reference for **Infrastructure / Aws Architecture**.

## Purpose

This document defines the role of **Aws Architecture** within PesaGuard. It provides a durable reference for runtime environments, platform dependencies, networking, deployment, and capacity, with enough detail for implementation, review, operations, and future change.
