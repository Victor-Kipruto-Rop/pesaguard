...
> Design and operating reference for **Infrastructure / Networking**.

## Purpose

This document defines the role of **Networking** within PesaGuard. It provides a durable reference for runtime environments, platform dependencies, networking, deployment, and capacity, with enough detail for implementation, review, operations, and future change.
