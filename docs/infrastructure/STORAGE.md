...
> Design and operating reference for **Infrastructure / Storage**.

## Purpose

This document defines the role of **Storage** within PesaGuard. It provides a durable reference for runtime environments, platform dependencies, networking, deployment, and capacity, with enough detail for implementation, review, operations, and future change.
