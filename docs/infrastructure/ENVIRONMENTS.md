...
> Design and operating reference for **Infrastructure / Environments**.

## Purpose

This document defines the role of **Environments** within PesaGuard. It provides a durable reference for runtime environments, platform dependencies, networking, deployment, and capacity, with enough detail for implementation, review, operations, and future change.
