...
> Design and operating reference for **Domains / Transactions / Transaction States**.

## Purpose

This document defines the role of **Transaction States** within PesaGuard. It provides a durable reference for business behavior, invariants, state transitions, and tenant-scoped workflows, with enough detail for implementation, review, operations, and future change.
