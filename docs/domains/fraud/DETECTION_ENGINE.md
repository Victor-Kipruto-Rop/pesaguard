...
> Design and operating reference for **Domains / Fraud / Detection Engine**.

## Purpose

This document defines the role of **Detection Engine** within PesaGuard. It provides a durable reference for business behavior, invariants, state transitions, and tenant-scoped workflows, with enough detail for implementation, review, operations, and future change.
