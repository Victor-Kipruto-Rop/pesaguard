...
> Design and operating reference for **Domains / Communications / Notification Policy**.

## Purpose

This document defines the role of **Notification Policy** within PesaGuard. It provides a durable reference for business behavior, invariants, state transitions, and tenant-scoped workflows, with enough detail for implementation, review, operations, and future change.
