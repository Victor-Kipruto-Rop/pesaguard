...
> Design and operating reference for **Domains / Reconciliation / Scoring**.

## Purpose

This document defines the role of **Scoring** within PesaGuard. It provides a durable reference for business behavior, invariants, state transitions, and tenant-scoped workflows, with enough detail for implementation, review, operations, and future change.
