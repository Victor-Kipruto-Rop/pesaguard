...
> Design and operating reference for **Product / Fraud Workflow**.

## Purpose

This document defines the role of **Fraud Workflow** within PesaGuard. It provides a durable reference for customer outcomes, scope boundaries, workflows, roles, and product decisions, with enough detail for implementation, review, operations, and future change.
