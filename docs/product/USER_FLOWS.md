...
> Design and operating reference for **Product / User Flows**.

## Purpose

This document defines the role of **User Flows** within PesaGuard. It provides a durable reference for customer outcomes, scope boundaries, workflows, roles, and product decisions, with enough detail for implementation, review, operations, and future change.
