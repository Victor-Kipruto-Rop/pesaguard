...
> Design and operating reference for **Product / User Roles**.

## Purpose

This document defines the role of **User Roles** within PesaGuard. It provides a durable reference for customer outcomes, scope boundaries, workflows, roles, and product decisions, with enough detail for implementation, review, operations, and future change.
