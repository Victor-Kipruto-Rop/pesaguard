...
> Design and operating reference for **Product / Roadmap**.

## Purpose

This document defines the role of **Roadmap** within PesaGuard. It provides a durable reference for customer outcomes, scope boundaries, workflows, roles, and product decisions, with enough detail for implementation, review, operations, and future change.
