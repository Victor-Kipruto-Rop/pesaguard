...
> Design and operating reference for **Product / Notification Workflow**.

## Purpose

This document defines the role of **Notification Workflow** within PesaGuard. It provides a durable reference for customer outcomes, scope boundaries, workflows, roles, and product decisions, with enough detail for implementation, review, operations, and future change.
