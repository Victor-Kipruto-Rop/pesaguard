...
> Design and operating reference for **Integrations / Mpesa / B2B**.

## Purpose

This document defines the role of **B2B** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
