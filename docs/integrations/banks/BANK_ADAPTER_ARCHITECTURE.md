# Bank Adapter Architecture

> Design and operating reference for **Integrations / Banks / Bank Adapter Architecture**.

## Purpose

This document defines the role of **Bank Adapter Architecture** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
