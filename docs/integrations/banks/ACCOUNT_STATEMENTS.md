...
> Design and operating reference for **Integrations / Banks / Account Statements**.

## Purpose

This document defines the role of **Account Statements** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
