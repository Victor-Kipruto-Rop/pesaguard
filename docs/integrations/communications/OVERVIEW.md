...
> Design and operating reference for **Integrations / Communications / Overview**.

## Purpose

This document defines the role of **Overview** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
