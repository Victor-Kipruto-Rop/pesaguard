...
> Design and operating reference for **Integrations / Airtel Money / Webhooks**.

## Purpose

This document defines the role of **Webhooks** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
