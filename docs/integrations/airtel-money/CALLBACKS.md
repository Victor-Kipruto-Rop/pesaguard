...
> Design and operating reference for **Integrations / Airtel Money / Callbacks**.

## Purpose

This document defines the role of **Callbacks** within PesaGuard. It provides a durable reference for provider boundaries, credentials, callbacks, normalization, and failure handling, with enough detail for implementation, review, operations, and future change.
