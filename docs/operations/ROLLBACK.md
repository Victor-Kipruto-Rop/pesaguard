...
> Design and operating reference for **Operations / Rollback**.

## Purpose

This document defines the role of **Rollback** within PesaGuard. It provides a durable reference for production ownership, release safety, monitoring, incident response, and recovery, with enough detail for implementation, review, operations, and future change.
