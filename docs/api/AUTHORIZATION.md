...
> Design and operating reference for **Api / Authorization**.

## Purpose

This document defines the role of **Authorization** within PesaGuard. It provides a durable reference for stable HTTP contracts, client behavior, compatibility, and operational safety, with enough detail for implementation, review, operations, and future change.
