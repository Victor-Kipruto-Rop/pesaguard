...
> Design and operating reference for **Api / Pagination**.

## Purpose

This document defines the role of **Pagination** within PesaGuard. It provides a durable reference for stable HTTP contracts, client behavior, compatibility, and operational safety, with enough detail for implementation, review, operations, and future change.
