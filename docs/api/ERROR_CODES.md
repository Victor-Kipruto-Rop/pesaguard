...
> Design and operating reference for **Api / Error Codes**.

## Purpose

This document defines the role of **Error Codes** within PesaGuard. It provides a durable reference for stable HTTP contracts, client behavior, compatibility, and operational safety, with enough detail for implementation, review, operations, and future change.
