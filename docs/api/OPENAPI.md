...
> Design and operating reference for **Api / Openapi**.

## Purpose

This document defines the role of **Openapi** within PesaGuard. It provides a durable reference for stable HTTP contracts, client behavior, compatibility, and operational safety, with enough detail for implementation, review, operations, and future change.
