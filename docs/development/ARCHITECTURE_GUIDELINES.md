...
> Design and operating reference for **Development / Architecture Guidelines**.

## Purpose

This document defines the role of **Architecture Guidelines** within PesaGuard. It provides a durable reference for contributor workflow, maintainability, review quality, and local engineering practice, with enough detail for implementation, review, operations, and future change.
