...
> Design and operating reference for **Development / Code Style**.

## Purpose

This document defines the role of **Code Style** within PesaGuard. It provides a durable reference for contributor workflow, maintainability, review quality, and local engineering practice, with enough detail for implementation, review, operations, and future change.
