...
> Design and operating reference for **Observability / Slis**.

## Purpose

This document defines the role of **Slis** within PesaGuard. It provides a durable reference for signals, telemetry, health, service-level objectives, and actionable alerting, with enough detail for implementation, review, operations, and future change.
