...
> Design and operating reference for **Observability / Logging**.

## Purpose

This document defines the role of **Logging** within PesaGuard. It provides a durable reference for signals, telemetry, health, service-level objectives, and actionable alerting, with enough detail for implementation, review, operations, and future change.
