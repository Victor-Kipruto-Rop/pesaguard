...
> Design and operating reference for **Observability / Health Checks**.

## Purpose

This document defines the role of **Health Checks** within PesaGuard. It provides a durable reference for signals, telemetry, health, service-level objectives, and actionable alerting, with enough detail for implementation, review, operations, and future change.
